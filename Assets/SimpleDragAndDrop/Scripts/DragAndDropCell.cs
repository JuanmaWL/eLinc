...
{
    SubirNivelyMonedas atributos;
    public GameObject LINCE;
    ...
    IEnumerator ExecuteAfterTime(float time)
    {
        ...
        GameObject canvas = gameObject.transform.parent.gameObject;
        GameObject comida = canvas.transform.Find("Plato")
            .gameObject.transform.Find("Comida").gameObject;
        comida.GetComponent<DragAndDropItem>().enabled = true;
        comida.GetComponent<Image>().color = new Color(255, 255, 255, 255);
        DestroyItem();
        Animator anim = LINCE.GetComponent<Animator>();
